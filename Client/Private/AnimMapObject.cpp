#include "stdafx.h"
#include "..\Public\AnimMapObject.h"
#include "GameInstance.h"
#include "ImGUI_Manager.h"

_uint CAnimMapObject::iFeatureMeshNumber = 0;

CAnimMapObject::CAnimMapObject(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
...
HRESULT CAnimMapObject::NativeConstruct_Prototype()
{
...
HRESULT CAnimMapObject::NativeConstruct(void * pArg)
{
...
void CAnimMapObject::Tick(_double TimeDelta)
{
...
void CAnimMapObject::LateTick(_double TimeDelta)
{
...
HRESULT CAnimMapObject::SetUp_Components(void* pArg)
{
	if (nullptr == pArg)
		return E_FAIL;
...
HRESULT CAnimMapObject::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CAnimMapObject * CAnimMapObject::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CAnimMapObject*	pInstance = new CAnimMapObject(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CAnimMapObject"));
...
CGameObject * CAnimMapObject::Clone(void * pArg)
{
	CAnimMapObject*	pInstance = new CAnimMapObject(*this);
