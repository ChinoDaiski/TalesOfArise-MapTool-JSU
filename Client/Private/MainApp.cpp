...
HRESULT CMainApp::Ready_Prototype_GameObject_UI()
{
	...
	if (FAILED(m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_HpUI"),
		UIHpBar::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
	...
	if (FAILED(m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_HpREDUI"),
		UIHpBarRed::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
	//TutoLineMsg와 헷갈리지말기
...
HRESULT CMainApp::Ready_Prototype_Component()
{
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_Shader_VtxTex"), CShader::Create(m_pDevice, m_pDeviceContext, TEXT("../Bin/ShaderFiles/Shader_VtxTex.hlsl"), VTXTEX_DECLARATION::Elements, VTXTEX_DECLARATION::iNumElements, CShader::FX))))
		return E_FAIL;
