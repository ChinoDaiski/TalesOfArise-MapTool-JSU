...
class CPractice final : public CEnemy
{
...
private:
	explicit CPractice(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CPractice(const CPractice& rhs);
	virtual ~CPractice() = default;
...
public:
	static CPractice* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
